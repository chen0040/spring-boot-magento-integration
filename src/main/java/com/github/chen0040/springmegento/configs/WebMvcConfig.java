...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
   ...
   public void addViewControllers(ViewControllerRegistry registry) {
      ...
      registry.addViewController("/html/commons/catalogue-detail").setViewName("html/commons/catalogue-detail");
      registry.addViewController("/html/commons/catalogue-form").setViewName("html/commons/catalogue-form");
      registry.addViewController("/html/commons/catalogue-management").setViewName("html/commons/catalogue-management");
   }
